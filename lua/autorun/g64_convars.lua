...
CreateConVar("g64_movement_only", "0", bit.bor(FCVAR_ARCHIVE, FCVAR_USERINFO, FCVAR_REPLICATED), "Movement Only mode - Mario handles movement, player stays visible and can't take Mario damage", 0, 1)
CreateConVar("g64_vr_attack_mode", "2", bit.bor(FCVAR_ARCHIVE, FCVAR_USERINFO), "VR attack mode: 0=trigger, 1=motion punch, 2=both", 0, 2)
CreateConVar("g64_vr_punch_threshold", "2.0", bit.bor(FCVAR_ARCHIVE, FCVAR_USERINFO), "VR motion punch velocity threshold", 0.1, 10)
CreateConVar("g64_vr_crouch_height", "46", bit.bor(FCVAR_ARCHIVE, FCVAR_USERINFO), "VR physical crouch height threshold", 10, 80)
CreateConVar("g64_vr_debug_crouch", "0", bit.bor(FCVAR_ARCHIVE), "Show VR crouch debug info on HUD", 0, 1)
